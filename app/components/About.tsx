        ...
        <section id="about" className="flex items-center justify-between px-[10%] py-16 pt-28 sm:mx-6 sm:flex-col sm:pt-12 sm:items-center sm:justify-center sm:gap-8">
            ...
            <div className="flex flex-col gap-8 items-center sm:justify-center">
                <div className="flex flex-col gap-4">
                    <h1 className="text-[var(--primary)] text-4xl font-bold text-center sm:text-3xl">SOBRE A MACLEAN</h1>
                ...
                <p className="w-[80%] sm:w-full sm:text-center">Somos uma empresa <span className="font-bold">especializada</span> em levar mais saúde para o seu lar, através da <span className="font-bold">limpeza e higienização</span> de sofás, colchões, tapetes e estofados em geral. Realizamos a higienização do seu estofado com máquina extratora e escova rotativa, produto <span className="font-bold">mundialmente conhecido</span> e aprovado da marca IPC BRASIL.</p>
                <div className="flex justify-between w-[80%] items-center gap-8 sm:w-full">
