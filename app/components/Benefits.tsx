...
function Benefits() {
    return (
        <div className="self-center absolute top-[570px] flex bg-[var(--primary-soft)] w-[60%] h-24 rounded-3xl p-8 items-center justify-between text-white sm:hidden md:w-[90%] md:top-[500px]">
