...
function Delivery() {
    ...
    return (
        <section className="flex items-center justify-center px-[10%] py-8 sm:px-6 sm:flex-col sm:justify-center sm:items-center">
            <Image src="/domicilio.webp" width={480} height={480} alt="domicilio" className="rounded-lg sm:order-1" />
            <div className="bg-[var(--primary)] flex flex-col gap-4 rounded-xl p-4 w-[400px] sm:w-full sm:gap-6 sm:text-center sm:py-8">
                ...
                <Button text="Solicitar orçamento" icon={<BsWhatsapp size={32}/>} onClick={handleWhatsapp} style="w-[340px] text-[18px] sm:w-full sm:py-3" />
            </div>
        </section>
    );
}
