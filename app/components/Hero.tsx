...
function Hero() {
    ...
    return (
        <section id="home" className="flex items-center justify-between bg-[var(--primary)] px-[10%] py-16 pb-24 sm:pt-28 sm:px-6 sm:justify-center sm:flex-col sm:gap-8 sm:pb-8">
